...
namespace StarterAssets
{
	...
	public class FirstPersonController : MonoBehaviour
	{
		...
		private void Start()
		{
            ...
            noiseProfile = _virtualCamera.GetCinemachineComponent<CinemachineBasicMultiChannelPerlin>();
		...
		private void Move()
		{
            ...
            {
                noiseProfile.m_AmplitudeGain = sprintAmplitude;
                noiseProfile.m_FrequencyGain = sprintFrequency;
            }
            else
            {
